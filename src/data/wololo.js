const civs = [
  ...
  },
  {
    ...
    castleAgeTech: 'Yeomen (Foot Archers and Skirmishers +1 range; Towers +2 Attack)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Manipur Cavalry (Cavalry and Arambai +6 Attack vs. Buildings, +3 of that blockable by building armor)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Logistica (Cataphracts cause 5 blast dmg (0.5 radius) and get +6 extra Attack vs. Ifantry)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Atheism (+100 years Relic, Wonder victories; Spies/Treason costs -50%)',
  ...
  },
  {
    ...
    uniqueUnit: 'Kamayuk (anti-Cavalry Infantry), Slinger (anti-Infantry Archer)',
    castleAgeTech: 'Andean Sling (Skirmishers, Slingers and Genitours no minimum range)',
  ...
  },
  {
    ...
    uniqueUnit: 'Elephant Archer (High HP, slow Cavalry Archer), Imperial Camel (Camel upgrade)',
  ...
  },
  {
    ...
    uniqueUnit: 'Genoese Crossbowman (anti-Cavalry Archer), Condottiero (anti-Gunpowder Infantry)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Double Crossbow (Ballista Elephants and Scorpions shoot two projectiles)',
  ...
  },
  {
    ...
    uniqueUnit: 'War Wagon (High HP, anti-Archer Cavalry Archer), Turtle Ship (heavily armored warship)',
  ...
  },
  {
    ...
    castleAgeTech: 'Thalassocracy (Upgrades your Docks to Harbors, which fire arrows)',
  ...
  },
  {
    ...
    castleAgeTech: 'Obsidian Arrows (Archer-line +6 Attack vs. Buildings, +6 vs. Stone Defense)',
  ...
  },
  {
    ...
    castleAgeTech: 'Boiling Oil (Castles +9 Attack vs. Rams, only affects the first arrow)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Druzhina (Infantry deal 5 damage in 0.5 radius per attack)',
  ...
  },
  {
    ...
    uniqueUnit: 'Conquistador (mounted Hand Cannoneer), Missionary (mounted Monk)',
    castleAgeTech: 'Inquisition (faster conversion: min/max conversion times -1s, -7s for Buildings)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Crenellations (+3 range Castle; garrisoned Infantry fire arrows)',
    teamBonus: 'Units resist conversion: min/max. Conversion time +1s/+2s, conversion chance halved'
  },
  {
    name: 'Turk',
    bonus: [
    ...
    imperialAgeTech: 'Artillery (+2 range Bombard Towers, Bombard Cannons, Cannon Galleons)',
  ...
  },
  {
    ...
    imperialAgeTech: 'Berserkergang (Berserks regenerate 2x faster, 1 HP/1.5s instead of 1 HP/3s)',
